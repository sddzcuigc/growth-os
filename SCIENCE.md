...
V2不再把八项能力平铺给孩子。系统只选择“一个底座能力 + 一个探索能力”，并显示具体证据、置信度、四周SMART/OKR和今天第一步。画像更新遵循：孩子明确更正 > 重复行为与作品 > 重复体验反馈 > 单次日记或模型推断。

完整产品与技术计划见 [PRODUCT_PLAN_V2.md](PRODUCT_PLAN_V2.md)。
